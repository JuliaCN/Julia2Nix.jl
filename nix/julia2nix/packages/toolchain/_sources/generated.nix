...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  julia-nightly-x86_64-linux = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-1F0N9008HKzwsn8ftI4kCW9ZgE7Smuo9ptuXjNB3AYY=";
    };
  };
}
