{pkgs ? import <nixpkgs> {}}: {
  ...
  depot = {
    ...
    "registries/General" = pkgs.fetchzip {
      ...
      "sha256" = "sha256-LFUdOhgv145nEoISFtvmISKou+X4gKyK0cEangnRQyE=";
      "stripRoot" = false;
      "url" = "https://pkg.julialang.org/registry/23338594-aafe-5451-b93e-139f81909106/72337dba8a9511ee52c68c43e4dc6855a11e81d0#registry.tar.gz";
    };
  };
}
